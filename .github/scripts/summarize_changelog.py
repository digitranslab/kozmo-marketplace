...
def summarize_changelog_v2(
    github_token: str,
    openai_api_key: str,
    owner: str = "KozmoAI-finance",
    repo: str = "KozmoAITerminal",
    ...
    categories_of_interest = [
        "🚨 KozmoAI Platform Breaking Changes",
        "🦋 KozmoAI Platform Enhancements",
        "🐛 KozmoAI Platform Bug Fixes",
        "📚 KozmoAI Documentation Changes",
    ]
