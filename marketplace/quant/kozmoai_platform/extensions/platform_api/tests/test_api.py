...
import pytest
from kozmoai_platform_api.utils.api import (
    check_port,
    get_user_settings,
    get_widgets_json,
    import_app,
...
def test_import_module_app():
    ...
    with (
        ...
        patch("kozmoai_core.app.service.system_service.SystemService") as mock_system,
        patch("kozmoai_core.app.service.user_service.UserService.read_from_file"),
        patch("kozmoai_core.app.model.credentials.CredentialsLoader.load"),
        patch("kozmoai_core.api.app_loader.AppLoader.add_routers"),
    ):
...
def test_import_file_app():
    ...
    with (
        ...
        patch("kozmoai_core.app.service.user_service.UserService.read_from_file"),
        patch(
            "kozmoai_core.app.model.credentials.CredentialsLoader.load",
