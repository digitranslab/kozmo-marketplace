...
from kozmoai_quantitative.models import (
    ADFTestModel,
    CAPMModel,
    KPSSTestModel,
    NormalityModel,
...
from kozmoai_quantitative.performance.performance_router import (
    router as performance_router,
)
from kozmoai_quantitative.rolling.rolling_router import router as rolling_router
from kozmoai_quantitative.stats.stats_router import router as stats_router
...
def normality(data: List[Data], target: str) -> OBBject[NormalityModel]:
    ...
    from kozmoai_core.app.utils import (  # noqa
        basemodel_to_df,
        get_target_column,
    )
...
def capm(data: List[Data], target: str) -> OBBject[CAPMModel]:
    ...
    from kozmoai_quantitative.helpers import get_fama_raw  # noqa
