...
def cointegration(
    ...
    """
    # pylint: disable=import-outside-toplevel
    from kozmoai_core.app.utils import basemodel_to_df, get_target_columns  # noqa
    from kozmoai_econometrics.utils import (  # noqa
...
def causality(
    ...
    """
    # pylint: disable=import-outside-toplevel
    from kozmoai_core.app.utils import basemodel_to_df, get_target_column
