...
from kozmoai_econometrics.utils import mock_multi_index_data
...
def get_stocks_data():
    ...
    data["stocks_data"] = kozmoai.obb.equity.price.historical(
...
def get_crypto_data():
    ...
    data["crypto_data"] = kozmoai.obb.crypto.price.historical(
        symbol=symbol, provider=provider
    ).results
    return data["crypto_data"]
