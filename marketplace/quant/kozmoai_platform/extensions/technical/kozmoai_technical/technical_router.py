...
from kozmoai_technical.helpers import (
    calculate_cones,
    calculate_fib_levels,
    clenow_momentum,
    validate_data,
)
from kozmoai_technical.relative_rotation import (
...
async def relative_rotation(
    ...
    chart_params : dict[str, Any], optional
        Additional parameters to pass when `chart=True` and the `kozmoai-charting` extension is installed.
