...
from kozmoai_charting.core.to_chart import to_chart
...
class TechnicalViews:
    ...
    @staticmethod
    def technical_sma(**kwargs) -> Tuple["KozmoAIFigure", Dict[str, Any]]:
    ...
    @staticmethod
    def technical_ema(**kwargs) -> Tuple["KozmoAIFigure", Dict[str, Any]]:
    ...
    @staticmethod
    def technical_hma(**kwargs) -> Tuple["KozmoAIFigure", Dict[str, Any]]:
    ...
    @staticmethod
    def technical_wma(**kwargs) -> Tuple["KozmoAIFigure", Dict[str, Any]]:
    ...
    @staticmethod
    def technical_zlma(**kwargs) -> Tuple["KozmoAIFigure", Dict[str, Any]]:
    ...
    @staticmethod
    def technical_aroon(**kwargs) -> Tuple["KozmoAIFigure", Dict[str, Any]]:
        """Technical Aroon Chart."""
        # pylint: disable=import-outside-toplevel
        from kozmoai_charting.core.plotly_ta.ta_class import PlotlyTA
    ...
    @staticmethod
    def technical_macd(**kwargs) -> Tuple["KozmoAIFigure", Dict[str, Any]]:
    ...
    @staticmethod
    def technical_adx(**kwargs) -> Tuple["KozmoAIFigure", Dict[str, Any]]:
    ...
    @staticmethod
    def technical_rsi(**kwargs) -> Tuple["KozmoAIFigure", Dict[str, Any]]:
    ...
    @staticmethod
    def technical_cones(**kwargs) -> Tuple["KozmoAIFigure", Dict[str, Any]]:
    ...
    def technical_relative_rotation(
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from kozmoai_charting.charts import relative_rotation  # noqa
        from kozmoai_charting.core.chart_style import ChartStyle  # noqa
        ...
        figure = KozmoAIFigure(fig)  # pylint: disable=E0606
