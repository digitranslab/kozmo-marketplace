...
class RelativeRotation:
    ...
    def __init__(
        ...
        from kozmoai_core.app.model.obbject import OBBject  # noqa
    ...
    def _process_data(self):
        """Process the data."""
        # pylint: disable=import-outside-toplevel
        from kozmoai_core.app.utils import df_to_basemodel
...
class RelativeRotationQueryParams(QueryParams):
    ...
    chart_params: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Additional parameters to pass when `chart=True` and the `kozmoai-charting` extension is installed."
    ...
    def convert_data(cls, v):
        ...
        from kozmoai_core.app.utils import convert_to_basemodel, df_to_basemodel
        from pandas import DataFrame
