...
from extensions.tests.utils.helpers import list_kozmoai_extensions
...
def parametrize(argnames: str, argvalues: List, **kwargs):
    ...
    routers, providers, obbject_ext = list_kozmoai_extensions()
    ...
    def decorator(function):
        ...
        extension_name = "kozmoai_" + name if name == "charting" else name
