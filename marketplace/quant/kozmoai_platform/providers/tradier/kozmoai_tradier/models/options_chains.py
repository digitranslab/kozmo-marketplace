...
from kozmoai_core.provider.standard_models.options_chains import (
    OptionsChainsData,
    OptionsChainsQueryParams,
)
from kozmoai_core.provider.utils.errors import EmptyDataError
from kozmoai_tradier.utils.constants import OPTIONS_EXCHANGES, STOCK_EXCHANGES
...
class TradierOptionsChainsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_tradier.models.equity_quote import TradierEquityQuoteFetcher  # noqa
        ...
        if expirations == []:
            raise KozmoAIError(f"No expiration dates found for {query.symbol}")
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_core.provider.utils.helpers import safe_fromtimestamp
