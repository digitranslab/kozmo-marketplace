...
from kozmoai_core.provider.standard_models.forward_ebitda_estimates import (
...
from kozmoai_fmp.utils.helpers import create_url, response_callback
...
class FMPForwardEbitdaEstimatesQueryParams(ForwardEbitdaEstimatesQueryParams):
    ...
    def check_symbol(cls, value):
        """Check the symbol."""
        if not value:
            raise KozmoAIError("Symbol is a required field for FMP.")
        return value
