...
from kozmoai_core.provider.standard_models.gdp_nominal import (
    GdpNominalData,
...
from kozmoai_oecd.utils.constants import CODE_TO_COUNTRY_GDP, COUNTRY_TO_CODE_GDP
...
class OECDGdpNominalFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_oecd.utils.helpers import oecd_date_to_python_date
        ...
        async def response_callback(response, _):
            ...
            if response.status != 200:
                raise KozmoAIError(f"Error with the OECD request: {response.status}")
