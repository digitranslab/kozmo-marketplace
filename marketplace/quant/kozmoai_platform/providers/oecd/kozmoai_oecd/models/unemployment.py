...
from kozmoai_core.provider.standard_models.unemployment import (
    UnemploymentData,
...
from kozmoai_oecd.utils.constants import (
...
class OECDUnemploymentFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_oecd.utils import helpers  # noqa
        ...
        if response.status_code != 200:
            raise KozmoAIError(f"Error: {response.status_code} -> {response.text}")
