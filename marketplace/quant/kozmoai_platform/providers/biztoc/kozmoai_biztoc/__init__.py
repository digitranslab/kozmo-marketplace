...
from kozmoai_biztoc.models.world_news import BiztocWorldNewsFetcher
...
we've partnered with KozmoAI, allowing you to pull in BizToc's news stream in their Terminal.""",
    credentials=["api_key"],
    fetcher_dict={
