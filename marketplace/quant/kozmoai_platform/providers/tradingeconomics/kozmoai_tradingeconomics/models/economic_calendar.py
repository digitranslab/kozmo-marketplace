...
from kozmoai_tradingeconomics.utils.countries import COUNTRIES
...
class TEEconomicCalendarFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_tradingeconomics.utils import url_generator
        from kozmoai_tradingeconomics.utils.helpers import response_callback
