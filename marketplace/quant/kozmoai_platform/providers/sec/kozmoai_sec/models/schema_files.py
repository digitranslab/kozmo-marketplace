...
from kozmoai_core.provider.standard_models.cot_search import CotSearchQueryParams
...
class SecSchemaFilesFetcher(Fetcher[SecSchemaFilesQueryParams, SecSchemaFilesData]):
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_sec.utils.helpers import get_schema_filelist

        if query.url and ".xsd" in query.url or query.url and ".xml" in query.url:
            raise KozmoAIError("Invalid URL. This endpoint does not parse the files.")
