...
from kozmoai_core.provider.standard_models.etf_holdings import (
    EtfHoldingsData,
...
class SecEtfHoldingsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_sec.utils.helpers import HEADERS, get_nport_candidates  # noqa
        ...
        if filing_candidates.empty:
            raise KozmoAIError(f"No N-Port records found for {query.symbol}.")
