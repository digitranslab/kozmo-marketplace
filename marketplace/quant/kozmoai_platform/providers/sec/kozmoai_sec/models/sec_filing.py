...
class SecBaseFiling(Data):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, url: str, use_cache: bool = True):
        ...
        from kozmoai_core.provider.utils.helpers import run_async
        from kozmoai_sec.utils.helpers import cik_map
    ...
    async def _adownload_file(url, use_cache: bool = True):
        ...
        from kozmoai_sec.utils.definitions import SEC_HEADERS
        from kozmoai_sec.utils.helpers import sec_callback
    ...
    def download_file(url, read_html_table: bool = False, use_cache: bool = True):
        ...
        # pylint: disable=import-outside-toplevel
        from kozmoai_core.provider.utils.helpers import run_async  # noqa
