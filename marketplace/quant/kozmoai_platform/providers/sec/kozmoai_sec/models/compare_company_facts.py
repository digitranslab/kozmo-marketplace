...
from kozmoai_core.provider.standard_models.compare_company_facts import (
...
from kozmoai_sec.utils.definitions import (
    FACT_CHOICES,
    FACTS,
    FISCAL_PERIODS,
)
...
class SecCompareCompanyFactsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_sec.utils.frames import get_concept, get_frame
