...
from kozmoai_core.provider.standard_models.currency_snapshots import (
...
class PolygonCurrencySnapshotsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        if results.get("status") != "OK":  # type: ignore[union-attr]
            raise KozmoAIError(f"Error: {results.get('status')}")  # type: ignore[union-attr]
    ...
    def transform_data(  # pylint: disable=too-many-locals, too-many-statements
        ...
        **kwargs: Any,
        ...
        from kozmoai_core.provider.utils.helpers import safe_fromtimestamp  # noqa
