...
from kozmoai_core.provider.standard_models.crypto_historical import (
...
class TiingoCryptoHistoricalFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Optional[Any],
        ...
        from kozmoai_tiingo.utils.helpers import get_data
        ...
        except (EmptyDataError, KozmoAIError, UnauthorizedError) as e:
            raise e from e
