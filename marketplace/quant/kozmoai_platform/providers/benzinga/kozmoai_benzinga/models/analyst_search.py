...
from kozmoai_core.provider.standard_models.analyst_search import (
    AnalystSearchData,
...
class BenzingaAnalystSearchFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from kozmoai_benzinga.utils.helpers import response_callback
        from kozmoai_core.provider.utils.helpers import amake_request, get_querystring
