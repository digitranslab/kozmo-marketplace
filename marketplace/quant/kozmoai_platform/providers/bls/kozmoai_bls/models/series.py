...
from kozmoai_core.provider.standard_models.bls_series import (
    SeriesData,
    SeriesQueryParams,
)
...
class BlsSeriesFetcher(Fetcher[BlsSeriesQueryParams, List[BlsSeriesData]]):
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_bls.utils.helpers import get_bls_timeseries
        ...
        if not results.get("data"):
            if messages:
                raise KozmoAIError(",".join(set(messages)))
