...
from kozmoai_bls.utils.constants import SURVEY_CATEGORIES, SURVEY_CATEGORY_NAMES
...
from kozmoai_core.provider.standard_models.bls_search import (
    SearchData,
    SearchQueryParams,
)
...
class BlsSearchFetcher(Fetcher[BlsSearchQueryParams, List[BlsSearchData]]):
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_bls.utils.helpers import open_asset
