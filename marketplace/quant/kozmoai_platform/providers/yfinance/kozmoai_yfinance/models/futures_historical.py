...
from kozmoai_yfinance.utils.references import INTERVALS_DICT, MONTHS
...
class YFinanceFuturesHistoricalFetcher(
    ...
    def transform_query(params: Dict[str, Any]) -> YFinanceFuturesHistoricalQueryParams:
        ...
        from kozmoai_yfinance.utils.helpers import get_futures_data
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from kozmoai_yfinance.utils.helpers import yf_download
