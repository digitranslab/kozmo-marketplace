...
from kozmoai_yfinance.utils.references import INTERVALS, MONTHS, PERIODS
...
async def get_futures_quotes(symbols: List) -> "DataFrame":
    ...
    from kozmoai_yfinance.models.equity_quote import YFinanceEquityQuoteFetcher  # noqa
...
async def get_historical_futures_prices(
    ...
    # pylint: disable=import-outside-toplevel
    from kozmoai_yfinance.models.equity_historical import (  # noqa
