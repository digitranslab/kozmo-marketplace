...
from kozmoai_core.provider.standard_models.short_term_energy_outlook import (
...
class EiaShortTermEnergyOutlookFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_us_eia.utils.helpers import response_callback
        ...
        try:
            ...
            raise KozmoAIError(f"Error fetching data from the EIA API -> {e}") from e
