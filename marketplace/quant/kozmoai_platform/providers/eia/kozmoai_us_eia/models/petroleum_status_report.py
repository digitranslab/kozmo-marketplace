...
class EiaPetroleumStatusReportFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from kozmoai_us_eia.utils.helpers import download_excel_file
        ...
        try:
            ...
            raise KozmoAIError(f"Error extracting data -> {e}") from e
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise KozmoAIError(f"Error transforming the data -> {e}") from e
