...
from kozmoai_core.provider.standard_models.economic_indicators import (
...
from kozmoai_imf.utils.constants import (
    FSI_PRESETS,
    IRFCL_PRESET,
    IRFCL_TABLES,
    load_symbols,
)
from kozmoai_imf.utils.irfcl_helpers import (
...
class ImfEconomicIndicatorsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_imf.utils.fsi_helpers import _get_fsi_data  # noqa
        from kozmoai_imf.utils.irfcl_helpers import _get_irfcl_data
        ...
        try:
            ...
            except (EmptyDataError, KozmoAIError) as e:
                if new_symbols_fsi:
                    exceptions.append(
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        if len(df) == 0:
            raise KozmoAIError("The data has a length of 0.")
