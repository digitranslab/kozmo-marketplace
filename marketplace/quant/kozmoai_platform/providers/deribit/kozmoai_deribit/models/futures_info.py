...
from kozmoai_core.provider.standard_models.futures_info import (
    FuturesInfoData,
...
class DeribitFuturesInfoQueryParams(FuturesInfoQueryParams):
    ...
    def _validate_symbol(cls, v):
        ...
        from kozmoai_deribit.utils.helpers import (
            get_futures_symbols,
...
class DeribitFuturesInfoFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        import asyncio  # noqa
        from kozmoai_core.provider.utils.errors import EmptyDataError, KozmoAIError
        from kozmoai_deribit.utils.helpers import get_ticker_data
        ...
        try:
            ...
            raise KozmoAIError(f"Error fetching data: {e}") from e
