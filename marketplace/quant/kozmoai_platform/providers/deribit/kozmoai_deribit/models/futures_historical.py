...
from kozmoai_core.provider.standard_models.futures_historical import (
...
from kozmoai_deribit.utils.helpers import DERIBIT_INTERVALS, DeribitIntervals
...
class DeribitFuturesHistoricalFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from kozmoai_deribit.utils.helpers import get_ohlc_data
