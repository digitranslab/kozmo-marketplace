...
from kozmoai_deribit.utils.helpers import DERIBIT_OPTIONS_SYMBOLS
...
class DeribitOptionsChainsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        import json
        import websockets
        from kozmoai_deribit.utils.helpers import get_options_symbols
        ...
        if messages and not results:
            raise KozmoAIError(", ".join(messages))
