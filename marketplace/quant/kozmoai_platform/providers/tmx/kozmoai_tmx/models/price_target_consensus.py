...
from kozmoai_core.provider.standard_models.price_target_consensus import (
...
class TmxPriceTargetConsensusQueryParams(PriceTargetConsensusQueryParams):
    ...
    def check_symbol(cls, value):
        """Check the symbol."""
        if not value:
            raise KozmoAIError("Symbol is a required field for TMX.")
        return value
...
class TmxPriceTargetConsensusFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        import asyncio  # noqa
        import json  # noqa
        from kozmoai_tmx.utils import gql  # noqa
        from kozmoai_tmx.utils.helpers import get_data_from_gql, get_random_agent  # noqa
