...
from kozmoai_core.provider.standard_models.spot import (
    SpotRateData,
    SpotRateQueryParams,
)
...
class FREDSpotRateFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any
        ...
        from kozmoai_fred.utils.fred_base import Fred
        ...
        if any(1 > m > 100 for m in maturity):
            raise KozmoAIError("Maturity must be between 1 and 100")
