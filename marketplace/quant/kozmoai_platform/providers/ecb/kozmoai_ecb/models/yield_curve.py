...
class ECBYieldCurveFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from kozmoai_ecb.utils.yield_curve_series import (
            MATURITIES,
            get_yield_curve_ids,
        )  # noqa
        ...
        async def get_one(maturity, use_cache):
            ...
            if not response:
                raise KozmoAIError("No data was returned.")
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        """Transform data."""
        # pylint: disable=import-outside-toplevel
        from kozmoai_ecb.utils.yield_curve_series import MATURITIES  # noqa
