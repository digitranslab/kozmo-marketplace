...
from kozmoai_core.provider.standard_models.historical_attributes import (
        ...
        **kwargs: Any,
        ...
        async def callback(
            ...
            if message := init_response.get(  # type: ignore
                ...
                warnings.warn(message=str(message), category=KozmoAIWarning)
                return []
            ...
            while next_page:
                ...
                if message := response_data.get("error") or response_data.get(  # type: ignore
                    ...
                    warnings.warn(message=message, category=KozmoAIWarning)
                    return []
