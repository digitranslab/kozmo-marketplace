...
from kozmoai_core.provider.standard_models.options_snapshots import (
...
class IntrinioOptionsSnapshotsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise KozmoAIError("Could not fetch data from Intrinio.") from exc
        ...
        if not urls:
            raise KozmoAIError("No snapshots found.")
        ...
        async def get_csv(url) -> DataFrame:
            ...
            try:
                ...
                try:
                    ...
                    raise KozmoAIError("Could not read file from URL.") from exc
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        df = data
        if df.empty:
            raise KozmoAIError("Empty CSV file")
        COL_MAP = {
