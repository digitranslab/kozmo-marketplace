...
from kozmoai_core.provider.standard_models.financial_ratios import (
    FinancialRatiosData,
    FinancialRatiosQueryParams,
)
from kozmoai_core.provider.utils.descriptions import QUERY_DESCRIPTIONS
from kozmoai_core.provider.utils.helpers import ClientResponse, amake_requests
from kozmoai_intrinio.utils.helpers import get_data_one
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        if query.period in ["quarter", "annual"]:
            ...
            raise KozmoAIError(f"Period '{query.period}' not supported.")
