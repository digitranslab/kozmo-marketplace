...
from kozmoai_core.provider.standard_models.etf_search import (
    EtfSearchData,
    EtfSearchQueryParams,
)
from kozmoai_core.provider.utils.errors import EmptyDataError
from kozmoai_intrinio.utils.references import ETF_EXCHANGES
        ...
        **kwargs: Any,
        ...
        async def response_callback(response: ClientResponse, session: ClientSession):
            ...
            if results.get("messages"):  # type: ignore
                ...
                raise KozmoAIError(str(messages))
