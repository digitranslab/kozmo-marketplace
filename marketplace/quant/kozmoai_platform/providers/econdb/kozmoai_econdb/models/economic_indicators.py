...
class EconDbEconomicIndicatorsQueryParams(EconomicIndicatorsQueryParams):
    ...
    def validate_countries(cls, v):
        ...
        from kozmoai_econdb.utils import helpers
        ...
        if v:
            ...
            if len(country) == 0:
                raise KozmoAIError("No valid countries were supplied.")
            return ",".join(country)
        return None
...
class EconDbEconomicIndicatorsFetcher(
    ...
    async def aextract_data(  # pylint: disable=R0914.R0912,R0915
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from kozmoai_econdb.utils import helpers
        from kozmoai_econdb.utils.main_indicators import get_main_indicators
        ...
        if not new_symbols:
            ...
            raise KozmoAIError(error_message)
