...
from kozmoai_core.provider.standard_models.port_volume import (
    PortVolumeData,
...
class EconDbPortVolumeFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        url = "https://www.econdb.com/static/kozmoai/shipping.json"

        try:
            response = await amake_request(url)
        except Exception as e:
            raise KozmoAIError("There was an error with the HTTP request") from e
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        """Transform the data."""
        # pylint: disable=import-outside-toplevel
        from kozmoai_econdb.utils.helpers import COUNTRY_MAP
