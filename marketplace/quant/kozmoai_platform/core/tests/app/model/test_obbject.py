...
import pandas as pd
import pytest
from kozmoai_core.app.model.obbject import Chart, OBBject, KozmoAIError
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([], KozmoAIError("Results not found.")),
        # Test case 11: Results as None, should raise KozmoAIError
        (None, KozmoAIError("Results not found.")),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [  # Case 1: Normal results with "date" column
        ...
        ([], KozmoAIError("Results not found.")),
        # Test case 5: Results as None, should raise KozmoAIError
        (None, KozmoAIError("Results not found.")),
        # Test case 6: List of tuples
        (
            [(3, 2), (1, 3), (2, 0), (3, 1), (4, 6)],
...
def test_show_chart_no_chart():
    ...
    # Act and Assert
    with pytest.raises(KozmoAIError, match="Chart not found."):
        mock_instance.show()
