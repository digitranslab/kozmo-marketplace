...
@patch("kozmoai_core.app.command_runner.CommandRunner.sync_run")
    ...
    [
        ...
        (
            ...
            escape(
                ...
                "\n[Providers]\n  * 'x' -> not installed, please install kozmoai-x\n  * 'y' -> not installed,"
                " please install kozmoai-y\n  * 'z' -> not installed, please install kozmoai-z"
            ),
        ),
    ],
)
