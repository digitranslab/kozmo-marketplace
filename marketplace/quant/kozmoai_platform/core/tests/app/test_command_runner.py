...
from kozmoai_core.app.command_runner import (
    CommandRunner,
    ExecutionContext,
    ParametersBuilder,
    StaticCommandRunner,
)
from kozmoai_core.app.model.abstract.warning import KozmoAIWarning
...
from kozmoai_core.app.provider_interface import ExtraParams
...
def test_parameters_builder_build(mock_func, execution_context):
    ...
    with patch("kozmoai_core.app.provider_interface.ProviderInterface") as mock_pi:
...
@patch("kozmoai_core.app.command_runner.CommandRunner")
def test_command_runner_run(_):
    """Test run."""
    runner = CommandRunner()

    with patch(
        "kozmoai_core.app.command_runner.StaticCommandRunner",
...
@pytest.mark.asyncio
@patch("kozmoai_core.app.router.CommandMap.get_command")
@patch("kozmoai_core.app.command_runner.StaticCommandRunner._execute_func")
...
@pytest.mark.asyncio
@patch("kozmoai_core.app.logs.logging_service.LoggingService")
@patch("kozmoai_core.app.command_runner.ParametersBuilder.build")
@patch("kozmoai_core.app.command_runner.StaticCommandRunner._command")
@patch("kozmoai_core.app.command_runner.StaticCommandRunner._chart")
