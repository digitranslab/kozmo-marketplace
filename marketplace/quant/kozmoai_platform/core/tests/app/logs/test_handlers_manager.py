...
from kozmoai_core.app.logs.handlers_manager import (
    HandlersManager,
...
def test_handlers_added_correctly():
    ...
    with patch(
        "kozmoai_core.app.logs.handlers_manager.PosthogHandler",
        MockPosthogHandler,
    ), patch(
        "kozmoai_core.app.logs.handlers_manager.PathTrackingFileHandler",
        MockPathTrackingFileHandler,
    ), patch(
        "kozmoai_core.app.logs.handlers_manager.FormatterWithExceptions",
