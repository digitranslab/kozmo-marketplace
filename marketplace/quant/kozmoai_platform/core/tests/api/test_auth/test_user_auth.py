...
from kozmoai_core.api.auth.user import (
    UserSettings,
    authenticate_user,
    get_user_service,
    get_user_settings,
...
@patch("kozmoai_core.api.auth.user.Env")
@patch("kozmoai_core.api.auth.user.HTTPBasicCredentials")
...
@patch("kozmoai_core.api.auth.user.UserService")
