...
from kozmoai_core.api.router.coverage import get_command_coverage, get_provider_coverage


@patch("kozmoai_core.api.router.coverage.CommandMap")
...
@patch("kozmoai_core.api.router.coverage.CommandMap")
@patch("kozmoai_core.api.router.coverage.ProviderInterface")
