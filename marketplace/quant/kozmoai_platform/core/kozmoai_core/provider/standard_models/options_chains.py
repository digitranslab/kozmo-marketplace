...
from kozmoai_core.provider.utils.options_chains_properties import OptionsChainsProperties
...
class OptionsChainsData(OptionsChainsProperties):
    ...
    ------
    KozmoAIError
        KozmoAIError will raise when accessing properties and methods if required, specific, data was not found.
    """
