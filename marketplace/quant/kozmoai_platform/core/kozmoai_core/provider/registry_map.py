...
from kozmoai_core.provider.registry import Registry, RegistryLoader
...
class RegistryMap:
        ...
        for p in registry.providers:
            for model_name, fetcher in registry.providers[p].fetcher_dict.items():
                ...
                if model_name not in standard_extra:
                    ...
                    standard_extra[model_name]["kozmoai"] = {
    ...
    def _update_json_schema_extra(
        ...
        standard_fields = model_map["kozmoai"]["QueryParams"]["fields"]
