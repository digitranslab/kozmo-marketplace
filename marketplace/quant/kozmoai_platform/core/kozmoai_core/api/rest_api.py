"""REST API for the KozmoAI Platform."""
...
from kozmoai_core.api.router.commands import router as router_commands
from kozmoai_core.api.router.coverage import router as router_coverage
from kozmoai_core.api.router.system import router as router_system
...
async def lifespan(_: FastAPI):
    ...
    banner = rf"""
                   ...
                   ███╗
  █████████████████╔══█████████████████╗       KozmoAI Platform v{system.version}
  ███╔══════════███║  ███╔══════════███║
  █████████████████║  █████████████████║       Authentication: {auth}
  ╚═════════════███║  ███╔═════════════╝
     ██████████████║  ██████████████╗
...
Investment research for everyone, anywhere.
    ...
    https://my.kozmoai.co/app/platform
...
if __name__ == "__main__":
    ...
    # This initializes the KozmoAI environment variables so they can be read before uvicorn is run.
    Env()
    ...
    uvicorn_app = uvicorn_kwargs.pop("app", "kozmoai_core.api.rest_api:app")
