"""The KozmoAI Platform System Settings."""
...
from kozmoai_core.app.constants import (
    HOME_DIRECTORY,
    KOZMOAI_DIRECTORY,
...
from kozmoai_core.app.model.api_settings import APISettings
from kozmoai_core.app.model.python_settings import PythonSettings
...
class SystemSettings(Tagged):
    ...
    kozmoai_directory: str = str(KOZMOAI_DIRECTORY)
    ...
    @classmethod
    def create_kozmoai_directory(cls, values: "SystemSettings") -> "SystemSettings":
        """Create the KozmoAI directory if it doesn't exist."""
        obb_dir = Path(values.kozmoai_directory).resolve()
