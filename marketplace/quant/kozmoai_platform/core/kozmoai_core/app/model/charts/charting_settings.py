...
from kozmoai_core.app.logs.utils.utils import get_app_id
...
class ChartingSettings:
    ...
    def __init__(
        ...
        user_settings_module = importlib.import_module(
            "kozmoai_core.app.model.user_settings", "UserSettings"
        )
        system_settings_module = importlib.import_module(
            "kozmoai_core.app.model.system_settings", "SystemSettings"
        )
