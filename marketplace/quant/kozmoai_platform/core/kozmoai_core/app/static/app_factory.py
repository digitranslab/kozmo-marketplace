...
from kozmoai_core.app.command_runner import CommandRunner
...
from kozmoai_core.app.static.account import Account
from kozmoai_core.app.static.container import Container
from kozmoai_core.app.static.coverage import Coverage
from kozmoai_core.app.static.reference_loader import ReferenceLoader
from kozmoai_core.app.version import VERSION

E = TypeVar("E", bound=Type[Container])
BASE_DOC = f"""KozmoAI Platform v{VERSION}
