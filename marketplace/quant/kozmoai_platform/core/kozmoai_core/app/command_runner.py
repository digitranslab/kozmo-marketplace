...
from kozmoai_core.app.model.abstract.warning import KozmoAIWarning, cast_warning
from kozmoai_core.app.model.metadata import Metadata
from kozmoai_core.app.model.obbject import OBBject
from kozmoai_core.app.provider_interface import ExtraParams
from kozmoai_core.app.static.package_builder import PathHandler
from kozmoai_core.env import Env
from kozmoai_core.provider.utils.helpers import maybe_coroutine, run_async
...
class StaticCommandRunner:
        ...
        **kwargs,
        ...
        try:
            if "charting" not in obbject.accessors:
                raise KozmoAIError(
                    "Charting is not installed. Please install `kozmoai-charting`."
                )
            ...
            if Env().DEBUG_MODE:
                raise KozmoAIError(e) from e
            warn(str(e), KozmoAIWarning)
    ...
    async def _execute_func(  # pylint: disable=too-many-positional-arguments
        ...
        # pylint: disable=import-outside-toplevel
        from kozmoai_core.app.logs.logging_service import LoggingService
