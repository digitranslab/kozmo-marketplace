...
from kozmoai_core.app.deprecation import DeprecationSummary, KozmoAIDeprecationWarning
from kozmoai_core.app.extension_loader import ExtensionLoader
from kozmoai_core.app.model.abstract.warning import KozmoAIWarning
from kozmoai_core.app.model.example import filter_list
...
class KozmoAIErrorResponse(BaseModel):
    """KozmoAI Error Response."""
        ...
        **kwargs,
        ...
        if func := SignatureInspector.complete(func, model):
            ...
            if kwargs.get("deprecated", False):
                deprecation: KozmoAIDeprecationWarning = kwargs.pop("deprecation")
...
class SignatureInspector:
    ...
    def get_operation_id(func: Callable, sep: str = "_") -> str:
        """Get operation id."""
        operation_id = [
            t.replace("_router", "").replace("kozmoai_", "")
        ...
        for route in api_router.routes:
            ...
            if openapi_extra:
                ...
                if model:
                    ...
                    if "kozmoai" in providers:
                        providers.remove("kozmoai")
