...
import pytest
from kozmoai_charting.charting import Charting
...
@patch("kozmoai_charting.charting.get_charting_functions_list")
...
@patch("kozmoai_charting.charting.Charting._handle_backend")
...
@patch("kozmoai_charting.charting.Charting._get_chart_function")
@patch("kozmoai_charting.charting.Chart")
...
@patch("kozmoai_charting.charting.Charting._prepare_data_as_df")
@patch("kozmoai_charting.charting.Charting._get_chart_function")
@patch("kozmoai_charting.charting.Chart")
