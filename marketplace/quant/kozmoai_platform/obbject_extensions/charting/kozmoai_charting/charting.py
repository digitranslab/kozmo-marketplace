...
from kozmoai_core.app.model.charts.chart import Chart
...
if TYPE_CHECKING:
    ...
    from kozmoai_charting.core.kozmoai_figure import KozmoAIFigure  # noqa
    from kozmoai_charting.query_params import ChartParams  # noqa
    from kozmoai_charting.core.backend import Backend  # noqa
...
class Charting:
    ...
    _extension_views: ClassVar[List[Type]] = [
        entry_point.load()
        for entry_point in entry_points(group="kozmoai_charting_extension")
    ]
    ...
    def __init__(self, obbject):
        ...
        charting_settings_module = importlib.import_module(
            "kozmoai_core.app.model.charts.charting_settings", "ChartingSettings"
        )
    ...
    def indicators(cls):
        ...
        """
        # pylint: disable=import-outside-toplevel
        from kozmoai_charting.query_params import IndicatorsParams
    ...
    def _handle_backend(self) -> "Backend":
        ...
        # pylint: disable=import-outside-toplevel
        from kozmoai_charting.core.backend import create_backend, get_backend
    ...
    def get_params(self) -> Union["ChartParams", None]:
        ...
        """
        # pylint: disable=import-outside-toplevel
        from kozmoai_charting.query_params import ChartParams
    ...
    def _prepare_data_as_df(
        ...
        # pylint: disable=import-outside-toplevel
        from kozmoai_core.app.utils import basemodel_to_df, convert_to_basemodel
    ...
    def create_line_chart(
        ...
        render: bool = True,
        **kwargs,
    ) -> Union["KozmoAIFigure", "Figure", None]:
        """Create a line chart from external data and render a chart or return the KozmoAIFigure.
        ...
        **kwargs: Dict[str, Any]
        ...
        """
        # pylint: disable=import-outside-toplevel
        from kozmoai_charting.charts.generic_charts import line_chart
    ...
    def create_correlation_matrix(
        ...
        """
        # pylint: disable=import-outside-toplevel
        from kozmoai_charting.charts.correlation_matrix import correlation_matrix
    ...
    def to_chart(
        ...
        **kwargs,
        ...
        """Create an KozmoAIFigure with user customizations (if any) and save it to the OBBject.
