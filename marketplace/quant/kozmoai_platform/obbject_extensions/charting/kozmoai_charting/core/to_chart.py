...
if TYPE_CHECKING:
    from kozmoai_charting.core.plotly_ta.data_classes import ChartIndicators  # noqa
...
def to_chart(
    ...
    -------
    Tuple[KozmoAIFigure, Dict[str, Any]]
        Tuple containing the KozmoAIFigure and the plotly json representation of the chart.
    """
