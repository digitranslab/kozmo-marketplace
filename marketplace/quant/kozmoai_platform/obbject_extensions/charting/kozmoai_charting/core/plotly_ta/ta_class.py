...
from kozmoai_charting.core.plotly_ta.base import PltTA
from kozmoai_charting.core.plotly_ta.data_classes import ChartIndicators
from kozmoai_charting.core.plotly_ta.ta_helpers import check_columns
...
class PlotlyTA(PltTA):
    ...
    def init_plot(self, symbol: str = "", candles: bool = True) -> KozmoAIFigure:
        ...
        """
        fig = KozmoAIFigure(charting_settings=self.charting_settings)
    ...
    def process_fig(self, fig: KozmoAIFigure, volume_ticks_x: int = 7) -> KozmoAIFigure:
        ...
        """
        new_subplot = KozmoAIFigure(charting_settings=self.charting_settings)
