...
from kozmoai_charting.core.config.kozmoai_styles import PLT_FIB_COLORWAY
from kozmoai_charting.core.kozmoai_figure import KozmoAIFigure
from kozmoai_charting.core.plotly_ta.base import PltTA, indicator
...
class Custom(PltTA):
    ...
    @indicator()
    def plot_srlines(self, fig: KozmoAIFigure, df_ta: pd.DataFrame):
    ...
    @indicator()
    def plot_fib(self, fig: KozmoAIFigure, df_ta: pd.DataFrame):
