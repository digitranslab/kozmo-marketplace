...
class Volume(PltTA):
    ...
    @indicator()
    def plot_ad(self, fig: KozmoAIFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_adosc(self, fig: KozmoAIFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_obv(self, fig: KozmoAIFigure, df_ta: pd.DataFrame, subplot_row: int):
