    ...
    def apply_style(self, style: Optional[str] = "") -> None:
        ...
        if self.plt_style and self.plotly_template:
            ...
            if "tables" in self.plt_styles_available:
                ...
                pio.templates["kozmoai_tables"] = go.layout.Template(tables)
            try:
                pio.templates["kozmoai"] = go.layout.Template(self.plotly_template)
            ...
            if style in ["dark", "white"]:
                pio.templates.default = f"plotly_{style}+kozmoai"
                return

            pio.templates.default = "kozmoai"
            self.mapbox_style = (
