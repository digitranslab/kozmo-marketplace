...
<figure style='text-align: center;'>
    <img src='https://kozmoai.co/assets/images/ogimages/Homepage.png' />
...
def update_data():
    st.session_state.news = fetch_kozmoai()
...
def main():
    with st.session_state.news_container.container():
        ...
        if st.session_state.news is not None:
            ...
            st.divider()
        st.write(
            "Learn more about the KozmoAI Platform [here](https://docs.kozmoai.co/platform)"
        )
