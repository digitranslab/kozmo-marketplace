...
import pytest
from kozmoai_cli.controllers.base_platform_controller import (
    PlatformController,
    Session,
)
...
@patch(
    "kozmoai_cli.controllers.base_platform_controller.PlatformController._link_obbject_to_data_processing_commands"
)
@patch(
    "kozmoai_cli.controllers.base_platform_controller.PlatformController._generate_commands"
)
@patch(
    "kozmoai_cli.controllers.base_platform_controller.PlatformController._generate_sub_controllers"
)
@pytest.mark.integration
