...
from kozmoai_core.app.version import get_package_version
from pydantic import BaseModel, ConfigDict, Field, model_validator
from pytz import all_timezones

VERSION = get_package_version("kozmoai-cli")
...
class Settings(BaseModel):
    ...
    # KOZMOAI
    HUB_URL: str = "https://my.kozmoai.co"
    BASE_URL: str = "https://payments.kozmoai.co"
    ...
    def from_env(cls, values: dict) -> dict:
        ...
        filtered = {k.replace("KOZMOAI_", ""): v for k, v in settings.items()}
        return filtered

    def set_item(self, key: str, value: Any) -> None:
        """Set an item in the model and save to .env."""
        setattr(self, key, value)
        set_key(str(ENV_FILE_SETTINGS), "KOZMOAI_" + key, str(value))
