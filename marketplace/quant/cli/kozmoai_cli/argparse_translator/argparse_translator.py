...
from kozmoai_cli.argparse_translator.argparse_argument import (
    ArgparseArgumentGroupModel,
    ArgparseArgumentModel,
)
from kozmoai_cli.argparse_translator.utils import (
...
class ArgparseTranslator:
    ...
    def _split_annotation(
        ...
        """Find the base annotation and the custom annotations, namely the KozmoAIField."""
    ...
    def _get_argument_custom_help(cls, param: inspect.Parameter) -> Optional[str]:
        ...
        _, custom_annotations = cls._split_annotation(base_annotation, KozmoAIField)
        help_annotation = (
