...
import pytest
from kozmoai_cli.controllers.base_platform_controller import PlatformController, Session
...
def mock_session():
    ...
    with patch(
        "kozmoai_cli.controllers.base_platform_controller.session",
...
def test_print_help(mock_session):
    ...
    with patch(
        "kozmoai_cli.controllers.base_platform_controller.MenuText"
    ) as mock_menu_text:
