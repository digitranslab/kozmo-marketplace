...
@patch("kozmoai_cli.controllers.cli_controller.CLIController.print_help")
...
@patch("kozmoai_cli.controllers.cli_controller.CLIController.switch", return_value=[])
@patch("kozmoai_cli.controllers.cli_controller.print_goodbye")
...
def test_execute_kozmoai_routine_with_mocked_requests():
    ...
    with patch("requests.get") as mock_get:
        ...
        controller = CLIController()
        controller.call_exe(
            ["--url", "https://my.kozmoai.co/u/test/routine/test.kozmoai"]
        )
        mock_get.assert_called_with(
            "https://my.kozmoai.co/u/test/routine/test.kozmoai?raw=true", timeout=10
        )
