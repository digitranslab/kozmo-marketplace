...
def test_default_values():
    ...
    assert fields["FLAIR"].default == ":kozmoai"
    ...
    assert fields["HUB_URL"].default == "https://my.kozmoai.co"
    assert fields["BASE_URL"].default == "https://payments.kozmoai.co"
...
@patch(
    "kozmoai_cli.models.settings.dotenv_values",
    return_value={"KOZMOAI_TEST_MODE": "True", "KOZMOAI_VERSION": "2.0.0"},
)
...
@patch("kozmoai_cli.models.settings.set_key")
@patch(
    "kozmoai_cli.models.settings.open",
